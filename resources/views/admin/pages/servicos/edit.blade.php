    ...
    <form method="POST" action="{{ route('admin.servicos.update', $servico) }}">
        ...
        <div class="row">
            <div class="form-group col- my-3">
                ...
                <textarea id="description" class="form-control @error('description') border-danger @enderror" name="description" required>{!! old('description', $servico->description) !!}</textarea>
                @error('description')
