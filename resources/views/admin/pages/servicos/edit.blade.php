        ...
        <div class="row">
            ...
            <div class="form-group col-md-6 col-sm-12 my-3">
                ...
                <select id="type" class="form-select @error('type') border-danger @enderror" name="type" required>
                    ...
                    <option {{ old('type', $servico->type) == "Manutenção" ? "selected" : "" }} value="Manutenção">Manutenção</option>
                    <option {{ old('type', $servico->type) == "Troca" ? "selected" : "" }} value="Troca">Troca</option>
                </select>
                @error('type')
