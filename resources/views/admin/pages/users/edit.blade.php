...
<div class="card my-4 p-4">
    <h5 class="text-muted title"><i class="fas fa-user-edit"></i> Editar Usuário</h5>
</div>
    ...
    <form method="POST" action="{{ route('admin.users.update', $user) }}">
        ...
        <div class="row">
            <div class="form-group col my-3">
                ...
                <input id="name" class="form-control @error('name') border-danger @enderror" type="text" value="{{ old('name', $user->name) }}" name="name" required>
                @error('name')
        ...
        <div class="row">
            <div class="form-group col-md-6 col-sm-12 my-3">
                ...
                <input id="email" class="form-control @error('email') border-danger @enderror" type="email" value="{{ old('email', $user->email) }}" name="email" required>
                @error('email')
